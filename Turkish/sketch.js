...
function calcWave() {
  ...
  function renderWave() {
    ...
    for (var x = 0; x < sivi.ydegerleri.length; x++) {
     ...
     if(sivi.sivitipi == 1){
     fill(255,255,255);
     text('Su (H₂O)', 10, canvas.height - 20);  
     }
     if(sivi.sivitipi == 2){
     fill(0,0,0);
     text('Fenolftalein', 10, canvas.height - 20); 
     }
     if(sivi.sivitipi == 3){
     fill(0,0,0);
  ...
  function getID(isim){
    switch(isim){
        case "sulfirik.":
        return "Sülfirik asit";
        case "hidroklorik.":
        return "Hidroklorik asit";
        case"kalsiyumkarbonat.":
        return "Kalsiyum karbonat";
        case"kalsiyumklorur.":
        return "Kalsiyum klorür";
        case"potaskostik.":
        return "Potasyum hidroksit";
        case"potasyumsulfat.":
        return "Potasyum sülfat";
        case"hidrojen.":
        return "Hidrojen";
        case"oksijen.":
        return "Oksijen";
        case "magnezyumsulfat.":
        return "Magnezyum sülfat";
        case "magnezyumelement.":
        return "Magnezyum";
        case "kalsiyumoksit.":
        return "Kalsiyum oksit";
        case "karbonikasit.":
        return "Karbonik asit";
        case "magnezyumklorur.":
        return "Magnezyum klorür";
        case "sodyumelement.":
        return "Sodyum";
        case "sodyumklorur.":
